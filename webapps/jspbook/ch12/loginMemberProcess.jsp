...
<%@ page import = "thinkonweb.bean.Member" %>
<%@ page import = "java.io.*" %>
<%
    ...
    try {
        String realPath = application.getRealPath("/ch12/member/member_"+ id);
        FileInputStream fis = new FileInputStream(realPath);

        if(fis != null) {
            ObjectInputStream ois = new ObjectInputStream(fis);
            thinkonweb.bean.Member storedMember = (thinkonweb.bean.Member)ois.readObject();
